...
@.str.3 = private unnamed_addr constant [18 x i8] c"Original array: \0A\00", align 1
@.str.4 = private unnamed_addr constant [36 x i8] c"\0ASorted array in Ascending order: \0A\00", align 1
...
20:                                               ; preds = %6
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  ret void
}
...
define dso_local i32 @main() #0 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3, i64 0, i64 0))
  %6 = getelementptr inbounds [5 x i32], [5 x i32]* %2, i64 0, i64 0
  %7 = load i32, i32* %3, align 4
  call void @printArray(i32* noundef %6, i32 noundef %7)
  %8 = getelementptr inbounds [5 x i32], [5 x i32]* %2, i64 0, i64 0
  %9 = load i32, i32* %3, align 4
  call void @selectionSort(i32* noundef %8, i32 noundef %9)
  %10 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i64 0, i64 0))
  %11 = getelementptr inbounds [5 x i32], [5 x i32]* %2, i64 0, i64 0
  %12 = load i32, i32* %3, align 4
  call void @printArray(i32* noundef %11, i32 noundef %12)
  ret i32 0
}
