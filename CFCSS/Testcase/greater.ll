...
@.str.1 = private unnamed_addr constant [15 x i8] c"both are equal\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"%d is greater\00", align 1
...
7:                                                ; preds = %0
  %8 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0))
  br label %20
...
13:                                               ; preds = %9
  ...
  %15 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i64 0, i64 0), i32 noundef %14)
  br label %19
